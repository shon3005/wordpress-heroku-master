...
if(THEMEDEMO && isset($_GET['layout']) && $_GET['layout'] == '3cols')
{
...
?>  
    <div class="inner three_cols">
    	...
    	<div class="inner_wrapper">
    			...
    			<div id="infinite_scroll_wrapper" class="sidebar_content full_width three_cols">
<?php
...
wp_register_script("photography-script-post-infinite-scroll", get_template_directory_uri()."/templates/script-post-infinite-scroll.php?current_query=".serialize($current_query)."&items=".$all_items."&items_ini=".THEMEINFINITEITEMS."&columns=3&action=grandblog_post", false, THEMEVERSION, true);
...
wp_enqueue_script("photography-script-post-infinite-scroll", get_template_directory_uri()."/templates/script-post-infinite-scroll.php?current_query=".serialize($current_query)."&items=".$all_items."&items_ini=".THEMEINFINITEITEMS."&columns=3&action=grandblog_post", false, THEMEVERSION, true);
