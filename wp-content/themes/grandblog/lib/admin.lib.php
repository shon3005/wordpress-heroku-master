...
array( "name" => "<h2>Import Demo Content</h2>",
	    	...
	    	<div class="item_content_wrapper">
	    		<div class="item_content">
	    			...
	    			<div class="item_content">
				    	...
				    	<a href="http://themes.themegoods.com/grandblog/demo">(See Sample)</a><br/><br/>
	...
	<input type="hidden" id="pp_import_demo_content" name="pp_import_demo_content" value="1"/>
